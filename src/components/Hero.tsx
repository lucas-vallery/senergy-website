      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20">
        {pattern === 'home' ? (
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="font-barlow text-4xl md:text-5xl font-bold text-white leading-tight mb-4">
              {title}
            </h1>
            ...
            {(ctaPrimary || ctaSecondary) && (
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                {ctaPrimary && (
                  <Link
                    href={ctaPrimary.href}
                    className="inline-flex items-center gap-2 bg-orange text-white font-semibold px-7 py-3.5 rounded-lg hover:bg-orange-dark transition-all shadow-lg"
                  >
                    {ctaPrimary.label}
                    <ArrowRight size={18} />
                  </Link>
